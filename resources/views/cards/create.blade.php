                    ...
                    <form method="POST" action="{{ route('cards.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="issuer" id="issuer" required
                                ...
                                <option value="AMEX" {{ old('issuer') == 'AMEX' ? 'selected' : '' }}>American Express</option>
                                <option value="VISA" {{ old('issuer') == 'VISA' ? 'selected' : '' }}>Visa</option>
                                <option value="Mastercard" {{ old('issuer') == 'Mastercard' ? 'selected' : '' }}>Mastercard</option>
                                <option value="Discover" {{ old('issuer') == 'Discover' ? 'selected' : '' }}>Discover</option>
                            </select>
                            @error('issuer')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="last_four" id="last_four" value="{{ old('last_four') }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
